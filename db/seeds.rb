...
#             ])
# Event.create([{:artist_id  => 1,
#                 :venue_id => 1,
#                 :name => 'The Shadowboxers Show',
#                 #:spotify_popularity => ,
#                 :seatgeek_popularity => 39.252,
